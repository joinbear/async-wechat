...
class User {
	constructor(wechat,appName) {
		...
		this.requestMethods = {
			...
			getUserList       : 'user/simplelist?fetch_child=1&status=0&department_id='
		}
	}
	/**
	...
	async getUserByDeptId(departmentId){
		return await this.handleGetRequest('getUserList',departmentId);
	}
	/**
	 * [createUser
	 *{
